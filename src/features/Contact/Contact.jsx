    ...
    <section id='contact'>
      ...
      <div className="contact__options">
        ...
        <MdOutlineMailOutline className='contact__option-icon'/>
          <h4>Email</h4>
          <a href="mailto:libraryismyparadise@gmail.com" target='_blank' rel="noreferrer">Send me a Email</a>
        </article>
        <article className="contact__option">
        <RiMessengerLine className='contact__option-icon'/>
          <h4>Messenger</h4>
          <a href="https://m.me/wolverinekrishna" target='_blank' rel="noreferrer">Send me a DM</a>
        </article>
        <article className="contact__option">
        <BsWhatsapp className='contact__option-icon'/>
          <h4>Whatsapp</h4>
          <a href=" https://wa.me/9779816398914" target='_blank' rel="noreferrer">Send me a Whatsapp</a>
        </article>
      </div>
