...
import {
  BsLinkedin, BsGithub, BsTwitter, BsMedium,
} from 'react-icons/bs';
...
function Socials() {
  return (
    <div className="header__socials">
      ...
      <a href="https://twitter.com/last_matrix" target="_blank" rel="noreferrer" aria-label="Twitter"><BsTwitter className="header__socials-icon" /></a>
